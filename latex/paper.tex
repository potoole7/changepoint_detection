...
\caption{
Test statistics calculated for each candidate season-year with 25-year time blocks. Results are shown for the test statistic $D$ using the Frobenius and infinity norms. Red points denote local peaks in the test statistic. \textcolor{red}{Need to mention that we rescale to be between 0 and 1 for plots!}}
