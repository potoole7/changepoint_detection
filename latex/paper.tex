...
\textcolor{red}{I've just included all the results and plots here, many will go into supplement!}

\subsubsection{Clustering maps for 2 and 4 clusters}

For Summer after the changepoint, the elbow plot suggests 2 clusters.
For Winter before the changepoint, the elbow plot suggests 4 clusters.

\begin{figure}[htb]
\centering
\includegraphics[width=0.9\linewidth]{plots/twgss_dqu_0.8.png}
\caption{
  Elbow plots for each season. 
}
% TODO Add label
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\linewidth]{plots/clust_map_dqu_0.8_k2.png}
\caption{
  Clustering solutions for $k = 2$ clusters. 
}
% TODO Add label
\end{figure}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\linewidth]{plots/clust_map_dqu_0.8_k4.png}
\caption{
  Clustering solutions for $k = 4$ clusters. 
}
% TODO Add label
\end{figure}
...
\subsubsection{Changepoints for Autumn}

\begin{itemize}
    \item Not bad results; South West locations become more like red ones, and Eastern points go from blue to red (orange characterised by being more like red locations than blue ones).
    \item Evidence of having higher temperature-DPI extremal dependence, as red locations have large $\chi$ \textcolor{red}{double check!}
\end{itemize}
...
\caption{
  Clustering solutions for $k = 3$ clusters, with a changepoint for Autumn.
}
% TODO Add label
\end{figure}
...
\caption{
  Dissimilarity matrices for differences before and after changepoints.
}
% TODO Add label
\end{figure}
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\linewidth]{plots/dist_diff_abs_all_dqu_0.8_trim.png}
\caption{
  Dissimilarity matrices for absolute differences before and after changepoints.
}
% TODO Add label
\end{figure}
...
\subsubsection{Clustering solutions vs covariates}
...
\subsubsection{Covariates and cluster membership}
