...
Desertification is one of Spain’s most pressing environmental challenges.  \cite{SpainDegradation} found that 20\% of the Spanish territory was degraded and an additional 1\% was undergoing an active process of environmental deterioration during the period 2000--2010. While part of this degradation may be attributable to factors such as agricultural practices and other land-use pressures, climate change may have also altered climatic conditions that are conducive to desertification and land degradation. In what follows we focus on this climatic dimension by applying our proposed changepoint methodology to check for potential shifts in the tail dependence structure of temperature and drought-related indicators across Spain. 
...
\item The accumulated precipitation is modelled using a Gamma distribution, whose parameters are estimated using unbiased probability-weighted moments.  \textcolor{orange}{CR: This and the next point are not detailed enough for me to embed it into the text.}
...
%$D=-\mathrm{SPI}$, so that larger values correspond to drier conditions. 
