...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\linewidth]{plots/clust_map_0.8_spring_trim.png}
\caption{
}
\caption{
Spatial clustering of the 40 Spanish stations obtained from the fitted conditional extremes dissimilarity matrix for Spring. 
